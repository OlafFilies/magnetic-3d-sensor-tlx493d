...
C++/C library of Infineon's [**XENSIV™ 3D Magnetic Sensor TLx493D**](https://www.infineon.com/cms/en/product/sensor/magnetic-sensors/magnetic-position-sensors/3d-magnetics/) family.
...
<table>
    <tr>
        <td><img src="docs/img/Arduino_Logo.png" width=200></td>
    </tr>
    <tr>
        <td style="text-align: center"><a href="https://github.com/Infineon/arduino-magnetic-3d-sensor-tlx493d">Arduino Library</a></td>
    </tr>
</table>

### More Information

This is the C/C++ core library of the **XENSIV™ 3D Magnetic Sensor TLx493D** family. If you want to use the library directly follow the link above in the supported frameworks section to get to the [Arduino library](https://github.com/Infineon/arduino-magnetic-3d-sensor-tlx493d).
