...
bool TLx493D_P2B6_setMeasurement(TLx493D_t *sensor, TLx493D_MeasurementType_t mVals);
bool TLx493D_P2B6_setTrigger(TLx493D_t *sensor, TLx493D_TriggerType_t trig);
bool TLx493D_P2B6_setSensitivity(TLx493D_t *sensor, TLx493D_SensitivityType_t sens);
...
bool TLx493D_P2B6_setUpdateRate(TLx493D_t *sensor, TLx493D_UpdateRateType_t rate);

bool TLx493D_P2B6_hasValidData(TLx493D_t *sensor);
bool TLx493D_P2B6_isFunctional(TLx493D_t *sensor);

bool TLx493D_P2B6_hasWakeUp(TLx493D_t *sensor);
bool TLx493D_P2B6_isWakeUpEnabled(TLx493D_t *sensor);
...
// utilities
uint8_t TLx493D_P2B6_calculateFuseParity(TLx493D_t *sensor);
...
void TLx493D_P2B6_calculateRawMagneticFieldAtTemperature(TLx493D_t *sensor, int16_t rawTemp, TLx493D_SensitivityType_t sens,
