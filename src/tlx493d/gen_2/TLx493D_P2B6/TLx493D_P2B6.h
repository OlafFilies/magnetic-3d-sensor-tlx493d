...
/**
 * @brief Initializes the XENSIV™ TLx493D-P2B6 magnetic 3D sensor
 * It initializes the sensor structure and sets the I2C communication protocol
 *
 * @param[in] sensor Pointer to the XENSIV™ TLx493D-P2B6 magnetic 3D sensor structure
...
/**
 * @brief De-Initializes the XENSIV™ TLx493D-P2B6 magnetic 3D sensor
...
/**
 * @brief Retrieves the temperature value of the XENSIV™ TLx493D-P2B6 magnetic 3D sensor
...
/**
 * @brief Retrieves the magnetic field values of the XENSIV™ TLx493D-P2B6 magnetic 3D sensor
...
// /**
//  * @brief Updates all registers of the XENSIV™ TLx493D-P2B6 magnetic 3D sensor
//  * 
//  * @param[in] sensor Pointer to the XENSIV™ TLx493D-P2B6 magnetic 3D sensor structure
//  * @return true - If successful
//  * @return false - If unsuccessful
