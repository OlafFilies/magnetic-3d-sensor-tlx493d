...
TEST_TEAR_DOWN(TLx493D_W2BW_needsSensorInternal)
{
}
/**
...
TEST_IFX(TLx493D_W2BW_needsSensorInternal, checkModeDefaultConfigFunctionality)
{
    ...
    TEST_ASSERT_EQUAL_HEX( dut.regMap[W2BW_MOD2_REG_e], 0x00 );
}
