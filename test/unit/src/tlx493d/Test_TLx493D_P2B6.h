...
TEST_GROUP(TLx493D_P2B6);
TEST_GROUP(TLx493D_P2B6_internal);


// Setup method called before every individual test defined for this test group
static TEST_SETUP(TLx493D_P2B6_internal)
{
...
static TEST_TEAR_DOWN(TLx493D_P2B6_internal)
{
...
TEST_IFX(TLx493D_P2B6_internal, checkCalculateMagneticFieldAndTemperature)
{
...
static TEST_GROUP_RUNNER(TLx493D_P2B6_internal)
{
    RUN_TEST_CASE(TLx493D_P2B6_internal, checkUnsupportedFunctionality);
    RUN_TEST_CASE(TLx493D_P2B6_internal, checkSupportedFunctionality);

    RUN_TEST_CASE(TLx493D_P2B6_internal, checkResetValues);
    RUN_TEST_CASE(TLx493D_P2B6_internal, checkCalculateMagneticFieldAndTemperature);
}


// Bundle all tests to be executed for this test group
TEST_GROUP_RUNNER(TLx493D_P2B6)
{
    TLx493D_P2B6_suiteSetUp();

    RUN_TEST_GROUP(TLx493D_P2B6_internal);
