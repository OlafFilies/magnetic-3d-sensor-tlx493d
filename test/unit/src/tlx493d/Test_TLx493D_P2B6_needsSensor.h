...
TEST_IFX(TLx493D_P2B6_needsSensorInternal, checkModeDefaultConfigFunctionality)
{
    ...
    TEST_ASSERT_EQUAL_HEX( dut.regMap[P2B6_CONFIG_REG_e], 0x00 );
    TEST_ASSERT_EQUAL_HEX( dut.regMap[P2B6_MOD1_REG_e], 0x94 ); // PR on, CA on
    TEST_ASSERT_EQUAL_HEX( dut.regMap[P2B6_MOD2_REG_e], 0x00 );
}
