...
TEST_GROUP(TLx493D_P3I8_internal);


// Setup method called before every individual test defined for this test group
static TEST_SETUP(TLx493D_P3I8_internal)
{
...
static TEST_TEAR_DOWN(TLx493D_P3I8_internal)
{
    dut.functions->deinit(&dut);
}


TEST_IFX(TLx493D_P3I8_internal, checkUnsupportedFunctionality)
{
}
...
TEST_IFX(TLx493D_P3I8_internal, checkResetValues)
{
    ...
    TEST_ASSERT_EQUAL_HEX( 0x62, dut.regMap[0x0A] ); // MOD1
    TEST_ASSERT_EQUAL_HEX( 0x00, dut.regMap[0x0B] ); // MOD2

    // for wake-up parity calculation
    TEST_ASSERT_EQUAL_HEX( 0x7F, dut.regMap[0x0C] );
    TEST_ASSERT_EQUAL_HEX( 0x80, dut.regMap[0x0D] );
    TEST_ASSERT_EQUAL_HEX( 0x7F, dut.regMap[0x0E] );
    TEST_ASSERT_EQUAL_HEX( 0x80, dut.regMap[0x0F] );  
    TEST_ASSERT_EQUAL_HEX( 0x7F, dut.regMap[0x10] );
    TEST_ASSERT_EQUAL_HEX( 0x80, dut.regMap[0x11] );
    TEST_ASSERT_EQUAL_HEX( 0xCC, dut.regMap[0x12] );
    TEST_ASSERT_EQUAL_HEX( 0x2C, dut.regMap[0x13] );
}


TEST_IFX(TLx493D_P3I8_internal, checkCalculateMagneticFieldAndTemperature)
{
...
static TEST_GROUP_RUNNER(TLx493D_P3I8_internal)
{
    RUN_TEST_CASE(TLx493D_P3I8_internal, checkUnsupportedFunctionality);
    RUN_TEST_CASE(TLx493D_P3I8_internal, checkSupportedFunctionality);

    RUN_TEST_CASE(TLx493D_P3I8_internal, checkResetValues);
    RUN_TEST_CASE(TLx493D_P3I8_internal, checkCalculateMagneticFieldAndTemperature);
}
...
TEST_GROUP_RUNNER(TLx493D_P3I8)
{
    ...
    RUN_TEST_GROUP(TLx493D_P3I8_internal);
