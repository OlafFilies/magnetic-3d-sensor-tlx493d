...
TEST_IFX(TLx493D_P3B6_needsSensorInternal, checkConfigSensitivityFunctionality)
{
    ...
    TEST_ASSERT( dut.functions->readRegisters(&dut) == true);
    TEST_ASSERT( (dut.regMap[P3B6_MOD2_REG_e] & 0x03) == 0x03 );
    ...
    TEST_ASSERT( dut.functions->readRegisters(&dut) == true);
    TEST_ASSERT( (dut.regMap[P3B6_MOD2_REG_e] & 0x03) == 0x01 );
    ...
    TEST_ASSERT( dut.functions->readRegisters(&dut) == true);
    TEST_ASSERT( (dut.regMap[P3B6_MOD2_REG_e] & 0x01) == 0x00 );
