#ifndef TEST_SENSORS_COMMON_FUNCTIONS_NEEDS_SENSOR_H
#define TEST_SENSORS_COMMON_FUNCTIONS_NEEDS_SENSOR_H
...
#endif // TEST_SENSORS_COMMON_FUNCTIONS_NEEDS_SENSOR_H
