...
TEST_GROUP(SensorsGen1Common_needsSensor);


// Setup method called before every individual test defined for this test group
static TEST_SETUP(SensorsGen1Common_needsSensor)
{
}


// Tear down method called before every individual test defined for this test group
static TEST_TEAR_DOWN(SensorsGen1Common_needsSensor)
{
}


// Define all relevant tests for the sensor device
TEST_IFX(SensorsGen1Common_needsSensor, dummy)
{
...
static TEST_GROUP_RUNNER(SensorsGen1Common_needsSensor)
{
